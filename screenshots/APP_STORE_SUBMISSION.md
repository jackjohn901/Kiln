# KilnFire — App Store Submission Package
Prepared for submission to Apple App Store.
...
When filling in the age rating questionnaire in App Store Connect, use these answers:
...
**Expected rating: 12+** (due to user-generated content)

---

## Screenshots

Six screenshots are included in this folder, all at 390×844px (iPhone viewport).

> **Note for submission:** Apple requires screenshots at **1290×2796px** (iPhone 16 Pro Max) or **1284×2778px** (iPhone 14 Pro Max). The screenshots in this folder are reference captures. For final submission, take these same screens on a real device via TestFlight or use Xcode Simulator set to iPhone 16 Pro Max and take screenshots at that resolution.

...
import aiHashtagsRouter from "./ai-hashtags";
import aiListingWriterRouter from "./ai-listing-writer";
...
import aiMarketingRouter from "./ai-marketing";
...
import receiptPdfRouter from "./receipt-pdf";
...
import savedSalesRangesRouter from "./saved-sales-ranges";
...
router.use(aiHashtagsRouter);
router.use(aiListingWriterRouter);
router.use(aiTranscribeRouter);
router.use(elevenlabsRouter);
router.use(aiEnhanceRouter);
router.use(aiMarketingRouter);
...
router.use(savedSalesRangesRouter);
